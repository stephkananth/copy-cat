...
private final class SwitchIfEmptySink<Observer: ObserverType>: Sink<Observer>, ObserverType {
...
private final class SwitchIfEmptySinkIter<Observer: ObserverType>: ObserverType {
    typealias Element = Observer.Element
