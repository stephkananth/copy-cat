...
extension ObservableType {
    ...
    public func flatMap<Source: ObservableConvertibleType>(_ selector: @escaping (Element) throws -> Source)
        -> Observable<Source.Element> {
            FlatMap(source: self.asObservable(), selector: selector)
    }
}
...
extension ObservableType {
    ...
    public func flatMapFirst<Source: ObservableConvertibleType>(_ selector: @escaping (Element) throws -> Source)
        -> Observable<Source.Element> {
            FlatMapFirst(source: self.asObservable(), selector: selector)
    }
}
...
extension ObservableType {
    ...
    public func concatMap<Source: ObservableConvertibleType>(_ selector: @escaping (Element) throws -> Source)
        -> Observable<Source.Element> {
        ConcatMap(source: self.asObservable(), selector: selector)
    }
}
...
private class MergeLimitedSink<SourceElement, SourceSequence: ObservableConvertibleType, Observer: ObserverType>: Sink<Observer>, ObserverType where Observer.Element == SourceSequence.Element {
