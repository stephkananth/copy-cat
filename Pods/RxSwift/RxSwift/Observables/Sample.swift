...
extension ObservableType {
    ...
    public func sample<Source: ObservableType>(_ sampler: Source, defaultValue: Element? = nil)
        -> Observable<Element> {
            Sample(source: self.asObservable(), sampler: sampler.asObservable(), defaultValue: defaultValue)
    }
}

private final class SamplerSink<Observer: ObserverType, SampleType>: ObserverType, LockOwnerType, SynchronizedOnType {
...
private final class SampleSequenceSink<Observer: ObserverType, SampleType>: Sink<Observer>, ObserverType, LockOwnerType, SynchronizedOnType {
