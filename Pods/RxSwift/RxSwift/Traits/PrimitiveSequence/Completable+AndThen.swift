...
private final class ConcatCompletableSink<Observer: ObserverType>: Sink<Observer>, ObserverType {
...
private final class ConcatCompletableSinkOther<Observer: ObserverType>: ObserverType {
