...
extension NSDate: TestOutputStringConvertible {
    public var testDescription: String {
        dateFormatter.string(from: Date(timeIntervalSinceReferenceDate: self.timeIntervalSinceReferenceDate))
    }
}
